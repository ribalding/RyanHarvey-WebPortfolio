<?php
    ...
    $email_to = "ryanjharvey88@gmail.com";
    ...
    $message_body = $_POST['message_body']; // required
...
@mail($email_to, "Contact Form Submission", $email_message, $headers);
?>
